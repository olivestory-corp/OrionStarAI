...
/**
 * Formats content length (character count) into a human-readable string
 * @param length The content length in characters
 * @returns A formatted string representing the length (e.g., "1.2K", "500")
 */
