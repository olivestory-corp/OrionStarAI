...
The tool appends the provided `fact` to a special context file located in the user's home directory (`~/.gemini/DEEPV.md`). This file can be configured to have a different name.
