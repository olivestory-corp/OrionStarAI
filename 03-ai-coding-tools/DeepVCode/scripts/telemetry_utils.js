...
// User-level .deepv directory in home
const USER_GEMINI_DIR = path.join(os.homedir(), '.deepv');
// Project-level .deepv directory in the workspace
const WORKSPACE_GEMINI_DIR = path.join(projectRoot, '.deepv');

// Telemetry artifacts are stored in a hashed directory under the user's ~/.deepv/tmp
